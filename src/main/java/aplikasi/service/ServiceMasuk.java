 ...
 * @author dimmaryanto
 */
public class ServiceMasuk implements RepoMasuk {

    private final DataSource ds;

    public ServiceMasuk(DataSource ds) {
        this.ds = ds;
    }

//    @Override
//    public Masuk save(Masuk b) throws SQLException {
...
//
//    @Override
//    public Masuk update(Masuk b) throws SQLException {
...
//
//    @Override
//    public List<Masuk> findAll() throws SQLException {
//        String sql = "SELECT \n"
...
//
//        List<Masuk> daftarPembelian = new ArrayList<>();
//        Connection connect = ds.getConnection();
//        PreparedStatement ps = connect.prepareStatement(sql);
...
//
//    @Override
//    public Masuk findOne(Integer id) throws SQLException {
//        String sql = "SELECT \n"
//                + "    b.id as id_pembelian, \n"
//                + "    b.kode as kode_pembelian,\n"
//                + "    b.tgl as tanggal_pembelian,\n"
...
//
//        PreparedStatement ps = connect.prepareStatement(sql);
//        for (MasukDetail pd : listPembelian) {
...
//
//    @Override
//    public List<MasukDetail> findPembelianDetailByPembelianId(Integer beli) throws SQLException {
//        String sql = "SELECT \n"
//                + "    b.id as id_pembelian, \n"
//                + "    b.kode as kode_pembelian,\n"
//                + "    b.tgl as tanggal_pembelian,\n"
...
//                + "WHERE b.id = ?";
//        List<MasukDetail> list = new ArrayList<>();
//
//        Connection connect = ds.getConnection();
//        PreparedStatement ps = connect.prepareStatement(sql);
//        ps.setInt(1, beli);
//        ResultSet rs = ps.executeQuery();
//        while (rs.next()) {
//            MasukDetail bd = new MasukDetail();
//
//            Masuk b = new Masuk();
//            b.setId(rs.getInt("id_pembelian"));
//            b.setKode(rs.getString("kode_pembelian"));
...
//    }
    ...
    @Override
    public Masuk save(Masuk value) throws SQLException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public Masuk update(Masuk value) throws SQLException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
