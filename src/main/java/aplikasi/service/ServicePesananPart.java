...
import aplikasi.repository.RepoPesananPart;
 ...
 * @author dimmaryanto
 */
public class ServicePesananPart implements RepoPesananPart {

    private final DataSource ds;

    public ServicePesananPart(DataSource ds) {
        this.ds = ds;
    }

//    @Override
//    public PesananPart save(PesananPart value) throws SQLException {
...
//    @Override
//    @Deprecated
//    public PesananPart update(PesananPart value) throws SQLException {
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//    }
//
//    @Override
//    public List<PesananPart> findAll() throws SQLException {
//        List<PesananPart> list = new ArrayList<>();
//        String sql = "SELECT\n"
...
//        while (rs.next()) {
//            PesananPart pp = new PesananPart();
...
//
//    @Override
//    public PesananPart findOne(String id) throws SQLException {
//        String sql = "SELECT\n"
//                + "    b.kode as kode_pesanan,\n"
//                + "    b.tgl as tanggal_pesanan,\n"
//                + "    p.id as kode_pemasok,\n"
...
//                + "WHERE b.kode = ?";
//        List<PesananPartDetail> list = new ArrayList<>();
//        Connection connect = ds.getConnection();
//        PreparedStatement ps = connect.prepareStatement(sql);
//        ps.setString(1, kode);
//        ResultSet rs = ps.executeQuery();
...
//            pp.setPemasok(p);
//
//            PesananPartDetail bd = new PesananPartDetail();
...
//        Connection connect = ds.getConnection();
//        PreparedStatement ps = connect.prepareStatement(sql);
//        for (PesananPartDetail pd : barangPesan) {
...
//    }
    ...
    @Override
    public PesananPart findOne(Integer id) throws SQLException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
