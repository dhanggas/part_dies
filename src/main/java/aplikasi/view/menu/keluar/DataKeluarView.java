...
public class DataKeluarView extends javax.swing.JInternalFrame {
    ...
    private final RepoOperator repoPelanggan;
    private final Keluar penjualan;
    private final MainMenuView menuController;
    private final TableViewController tableController;

    private List<Operator> daftarPelanggan = new ArrayList<>();
    private List<KeluarDetail> daftarPenjualanBarang = new ArrayList<>();
     ...
     */
    public DataKeluarView(MainMenuView menuController) {
        this.repoPenjualan = new ServiceKeluar(KoneksiDB.getDataSource());
        this.repoPelanggan = new ServiceOperator(KoneksiDB.getDataSource());

        this.penjualan = new Keluar();
        ...
        refreshPelanggan();
//        try {
//            List<Keluar> daftarPenjualan = repoPenjualan.findAll();
...
//            for (Operator pelanggan : daftarPelanggan) {
...
//        Double total = 0D;
//        for (KeluarDetail pd : daftarPenjualanBarang) {
...
//        txtTotal.setText(ValueFormatterFactory.getCurrency(total));
    ...
    public void tambahBarang(KeluarDetail pd) {
        daftarPenjualanBarang.add(pd);
        refreshDataTable();
    }

    public void hapusBarang(KeluarDetail pd) {
    ...
    private void initComponents() {
        ...
        txtKodePelanggan = new javax.swing.JComboBox<String>();
...
//            Operator pelanggan = daftarPelanggan.get(txtKodePelanggan.getSelectedIndex());
...
//        }
    ...
    private void btnTambahBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahBarangActionPerformed
        if (txtKodePelanggan.getSelectedItem() != null) {
            Operator pelanggan = daftarPelanggan.get(txtKodePelanggan.getSelectedIndex());
            DataKeluarDetailView view = new DataKeluarDetailView(menuController, true, this, penjualan, pelanggan);
    ...
    private void btnHapusBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusBarangActionPerformed
        if (tableController.isSelected()) {
            KeluarDetail pd = daftarPenjualanBarang.get(tableController.getRowSelected());
            hapusBarang(pd);
        } else {
    ...
    private void btnKembeliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKembeliActionPerformed
        try {
            DataKeluarView view = new DataKeluarView(menuController);
...
//            }
//            Double total = 0D;
//            for (KeluarDetail jual : daftarPenjualanBarang) {
