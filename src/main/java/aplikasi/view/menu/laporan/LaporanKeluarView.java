...
public class LaporanKeluarView extends javax.swing.JInternalFrame {
    ...
    private List<Keluar> daftarPenjualan = new ArrayList<>();
    private List<KeluarDetail> daftarDetailPenajualan = new ArrayList<>();

    public LaporanKeluarView(MainMenuView aThis) {
...
//            for (Keluar penjualan : daftarPenjualan) {
//                Object[] row = {
//                    penjualan.getKode(),
...
//            Logger.getLogger(LaporanKeluarView.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }

    private void setFields(Keluar jual) {
//        try {
//            txtKodePenjualan.setText(jual.getKode());
//
//            Operator p = jual.getPelanggan();
...
//            for (KeluarDetail detailJual : daftarDetailPenajualan) {
//                Part barang = detailJual.getBarang();
...
//        }
    ...
    private void tablePenjualanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablePenjualanMouseClicked
        if (tablePenjualanController.isSelected()) {
            Keluar penjualan = daftarPenjualan.get(tablePenjualanController.getRowSelected());
            setFields(penjualan);
        } else {
            clearFields();
        }
