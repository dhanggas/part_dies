 ...
 */
package aplikasi.view.menu.operator;
...
import aplikasi.service.ServiceOperator;
 ...
 * @author dimmaryanto
 */
public class DaftarOperatorView extends javax.swing.JInternalFrame {

    private static final long serialVersionUID = 1L;

    private final TableViewController tableController;
    private List<Operator> daftarPelanggan;
    private final RepoOperator repo;
     ...
     * @param frame
     */
    public DaftarOperatorView(JFrame frame) {
        initComponents();
        this.tableController = new TableViewController(tableView);
        this.daftarPelanggan = new ArrayList<>();
        this.repo = new ServiceOperator(KoneksiDB.getDataSource());
        this.frame = frame;
        refreshDataTable();
    }

    private void setFields(Operator p) {
...
//            for (Operator p : daftarPelanggan) {
...
//            Logger.getLogger(DaftarOperatorView.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }
    ...
    private void tableViewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableViewMouseClicked
        if (tableController.isSelected()) {
            Operator p = daftarPelanggan.get(tableController.getRowSelected());
            setFields(p);
        } else {
            clearFields();
        }
...
//        tableController.getSorter().setRowFilter(RowFilter.regexFilter(txtCari.getText()));
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        DataOperatorView view = new DataOperatorView(frame, this, true);
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        if (tableController.isSelected()) {
            Operator pelanggan = daftarPelanggan.get(tableController.getRowSelected());
            DataOperatorView view = new DataOperatorView(frame, true, pelanggan, this);
            view.setLocationRelativeTo(null);
            view.setResizable(false);
            view.setVisible(true);
        } else {
