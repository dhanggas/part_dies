 ...
 * @author dimmaryanto
 */
public class DataOperatorView extends javax.swing.JDialog {

    private static final long serialVersionUID = 1L;
    private final RepoOperator repo = new ServiceOperator(KoneksiDB.getDataSource());
    private Boolean update;
    private Operator pelanggan;
    private DaftarOperatorView daftarPelanggan;
     ...
     * @param modal
     */
    public DataOperatorView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setUpdate(false);
...
//            this.pelanggan = new Operator();
//            this.pelanggan.setKode(sb.toString());
//            this.pelanggan.setAgen(false);
//            txtKode.setText(pelanggan.getKode());
//        } catch (SQLException ex) {
//            Logger.getLogger(DataOperatorView.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }

    public DataOperatorView(java.awt.Frame parent, DaftarOperatorView daftarPelangganView, boolean modal) {
        super(parent, modal);
        initComponents();
        setUpdate(false);
...
//        }
    ...
    public DataOperatorView(java.awt.Frame parent, boolean modal, Operator p, DaftarOperatorView daftarPelanggan) {
        super(parent, modal);
        initComponents();
        setUpdate(true);
        setFields(p);
