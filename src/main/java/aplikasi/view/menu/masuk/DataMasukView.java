...
public class DataMasukView extends javax.swing.JInternalFrame {
    ...
    private final List<MasukDetail> daftarBelanjaan = new ArrayList<>();

    public DataMasukView(MainMenuView menuController) {
    ...
    public void tambahBarangBelanjaan(MasukDetail pd) {
        daftarBelanjaan.add(pd);
        refrestDataTable();
    }

    public void hapusBarangBelanjaan(MasukDetail pd) {
...
//        for (MasukDetail belanja : daftarBelanjaan) {
//            Double subTotal = belanja.getJumlah() * belanja.getHarga();
//            Part brg = belanja.getBarang();
//            Object[] row = {
//                brg.getKode(),
//                brg.getNama(),
...
//        txtTotal.setText(ValueFormatterFactory.getCurrency(grantTotal));
    ...
    private void btnKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKembaliActionPerformed
        try {
            DataMasukView view = new DataMasukView(menuController);
    ...
    private void btnTambahBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahBarangActionPerformed
        DataMasukDetailView view = new DataMasukDetailView(menuController, true, this, pembelian);
