 ...
 * @author dimmaryanto
 */
public class DataMasukDetailView extends javax.swing.JDialog {
    ...
    private final DataMasukView pembelianController;
    private final Masuk pembelian;

    DataMasukDetailView(MainMenuView menuController, boolean modal, DataMasukView pembelianController, Masuk pembelian) {
...
//            Logger.getLogger(DataMasukDetailView.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }
...
//        txtHargaBeli.setValue(brg.getHargaBeli());
    ...
    private void initComponents() {
        ...
        txtJumlahBeli.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(1), Integer.valueOf(1), null, Integer.valueOf(5)));
        txtJumlahBeli.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                txtJumlahBeliAncestorAdded(evt);
            }
        ...
        txtHargaBeli.setModel(new javax.swing.SpinnerNumberModel(Double.valueOf(0.0d), Double.valueOf(0.0d), null, Double.valueOf(500.0d)));
...
//        if (tableController.isSelected()) {
//            Part brg = daftarBarang.get(tableController.getRowSelected());
//            MasukDetail pd = new MasukDetail();
//            pd.setBarang(brg);
...
//        }
    ...
    private void txtJumlahBeliAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_txtJumlahBeliAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_txtJumlahBeliAncestorAdded
