 ...
 * @author dimmaryanto
 */
public class DataPartView extends javax.swing.JDialog {

    private Boolean update;
    private final RepoPart repoBarang = new ServicePart(KoneksiDB.getDataSource());
    private Part barang;
    private DaftarPartView daftarBarangController = null;
     ...
     * @param modal
     */
    public DataPartView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setUpdate(false);
        this.barang = new Part();
        refreshDataKategoriBarang();
    }

    DataPartView(java.awt.Frame parent, DaftarPartView daftarBarangController, boolean modal) {
        super(parent, modal);
        initComponents();
        setUpdate(false);
    ...
    DataPartView(java.awt.Frame parent, DaftarPartView daftarBarangController, Part brg, boolean modal) {
        super(parent, modal);
        initComponents();
        setUpdate(true);
        refreshDataKategoriBarang();
...
//            Logger.getLogger(DataPartView.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }
    ...
    private void initComponents() {
        ...
        txtJumlah.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(5)));
