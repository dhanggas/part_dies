 ...
 * @author dimmaryanto
 */
public class DataMasukDariPesananDetailBarangView extends javax.swing.JDialog {

    private final MasukDetail pembelianDetail;
     ...
     * @param modal
     */
    DataMasukDariPesananDetailBarangView(MainMenuView parent, boolean modal, DataMasukDariPemesananView pembelianController, MasukDetail pembelianDetail, Integer position) {
        super(parent, modal);
        initComponents();
    ...
    private void setFields(MasukDetail pd) {
...
//        txtHarga.setValue(pd.getHarga());
    ...
    private void initComponents() {
        ...
        txtHarga.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(500)));
