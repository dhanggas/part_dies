 ...
 */
package aplikasi.view.menu.pemesanan.pemasukan;
 ...
 * @author dimmaryanto
 */
public class DataMasukDariPesananDetailView extends javax.swing.JDialog {

    private final DataMasukDariPemesananView pembelianController;
    ...
    DataMasukDariPesananDetailView(MainMenuView menuController, boolean modal,
            DataMasukDariPemesananView pembelianController, Masuk pembelian) {
...
//            Logger.getLogger(DataMasukDariPesananDetailView.class.getName()).log(Level.SEVERE, null, ex);
//        }
...
//            pembelianController.tambahBarang(pd);
//            this.dispose();
//        } else {
