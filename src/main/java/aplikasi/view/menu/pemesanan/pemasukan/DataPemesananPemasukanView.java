 ...
 * @author dimmaryanto
 */
public class DataPemesananPemasukanView extends javax.swing.JInternalFrame {

    private final RepoPemasok repoPemasok;
    private final RepoPesananPart repoPesananaPembelian;
    private final MainMenuView menuController;
    private final PesananPart pesanBarang;
    private final List<PesananPartDetail> daftarBelajaan;
    private final TableViewController tableController;
    private List<Pemasok> daftarPemasok;

    public void tambahBarangBelanjaan(PesananPartDetail belanja) {
        this.daftarBelajaan.add(belanja);
    }

    public DataPemesananPemasukanView(MainMenuView menuController) {
        this.menuController = menuController;
        this.pesanBarang = new PesananPart();
        ...
        this.repoPesananaPembelian = new ServicePesananPart(KoneksiDB.getDataSource());
        initComponents();
        refreshDataPemasok();
...
//
//            List<PesananPart> daftarPO = repoPesananaPembelian.findAll();
//            sb.append(String.format("%02d", daftarPO.size() + 1));
//            txtKode.setText(sb.toString());
//            this.pesanBarang.setKode(sb.toString());
//        } catch (SQLException ex) {
//            Logger.getLogger(DataPemesananPemasukanView.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }

    public void refreshDataTable() {
        tableController.clearData();
//        for (PesananPartDetail belanja : daftarBelajaan) {
...
//        txtTelpPemasok.setText(p.getTlp());
    ...
    private void initComponents() {
        ...
        txtKodePemasok = new javax.swing.JComboBox<String>();
    ...
    private void btnTambahBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahBarangActionPerformed
        DataPemesananPemasukanDetailView view = new DataPemesananPemasukanDetailView(menuController, true, pesanBarang, this);
    ...
    private void btnKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKembaliActionPerformed
        try {
            DataPemesananPemasukanView view = new DataPemesananPemasukanView(menuController);
...
//        }
    ...
    private void btnHapusBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusBarangActionPerformed
        if (tableController.isSelected()) {
            PesananPartDetail pd = daftarBelajaan.get(tableController.getRowSelected());
