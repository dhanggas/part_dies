 ...
 * @author dimmaryanto
 */
public class DataPemesananPemasukanDetailView extends javax.swing.JDialog {
    ...
    private final PesananPartDetail pesan;
    private final PesananPart pesananPembelian;
    private final DataPemesananPemasukanView pesananController;

    DataPemesananPemasukanDetailView(java.awt.Frame parent, boolean modal, 
        PesananPart pesanBarang, DataPemesananPemasukanView pemesananPembelianController) {
        super(parent, modal);
        initComponents();
        ...
        this.pesan = new PesananPartDetail();
...
//            Logger.getLogger(DataPemesananPemasukanDetailView.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }
...
//        txtStok.setText(ValueFormatterFactory.getNumberBulat(brg.getJumlah()));
    ...
    private void initComponents() {
        ...
        txtJumlah.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(1), Integer.valueOf(1), null, Integer.valueOf(5)));
